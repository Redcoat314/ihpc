        		...
        		<div class="mid-cont">
        			<div class="contain-both">
        				<div class="unit-wrap float-left">
                            ...
                            <ul class="unit-list">
                				<?php 
									$sql="SELECT * FROM `epaper_allotment` WHERE `sid`=(select `sid` from `subject` where `uri`='".$sr."') order by `batch`";
									$res=mysqli_query($con,$sql);
									$c=0;
									$flinnk="";
									while($row=mysqli_fetch_array($res)){
										if($c==0){
                                    		$flinnk="http://localhost/ihpc/uploads/exam-papers/".$row["ep_link"];
                                   		}
								?>
                                	<li class="li-tag">
                                	<div class="float-left">
                                    	<a href="http://localhost/ihpc/uploads/study-material/<?php echo $row["ep_link"]; ?>" target="reader">
                                    ...
                                    <div class="float-right">
                                        ...
                                        <div class="small-text">
                                        	<a href="http://localhost/ihpc/uploads/exam-papers/<?php echo $row["ep_link"]; ?>" target="_blank">Download</a>
                                        </div>
                                    </div>
